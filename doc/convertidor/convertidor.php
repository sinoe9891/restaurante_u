         ...
         if(trim($xaux) != "")
         {
            switch ($xz)
            {
               ...
               case 2:
                  if($xcifra < 1)
                  {
                     $xcadena = "CERO CON $xdecimales/100 " .strtoupper($centimos).strtoupper($moneda) ;  // borrar en caso no se desee decimales /100
                  }
                  if($xcifra >= 1 && $xcifra < 2)
                  {
                     $xcadena = "UNO CON $xdecimales/100 ".strtoupper($centimos).strtoupper($moneda);   // borrar en caso no se desee decimales /100
                  }
                  if($xcifra >= 2)
                  {
                     $xcadena .= " CON $xdecimales/100 ".strtoupper($centimos).strtoupper($moneda);  // borrar en caso no se desee decimales /100
                  }
                  break;
            } // endswitch ($xz)
         } // ENDIF (trim($xaux) != "")
